...
export default function VideoCallModal({ localStream, remoteStream, onEndCall }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#020617] flex flex-col items-center justify-center animate-fade-in-up">
      ...
      {/* MAIN BACKGROUND VIDEO (Remote User) 
      */}
      <div className="absolute inset-0 bg-slate-900">
        {remoteStream ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center text-slate-500">
            ...
            <p className="font-medium animate-pulse">Connecting video...</p>
          </div>
        )}
      </div>

      {/* FLOATING PICTURE-IN-PICTURE (Local User) 
      */}
      ...
      */}
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex items-center gap-6 bg-slate-900/60 backdrop-blur-md px-8 py-4 rounded-full border border-slate-700/50 z-10 shadow-2xl">
        ...
        >
          {/* Hang Up Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 group-hover:rotate-[135deg] transition-transform duration-300">
