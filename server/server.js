...
io.on("connection", (socket) => {
    ...
    socket.on("setup", async (userData) => {
        ...
        if (userData._id) {
            ...
            // Automatically join all channels
            ...
            try {
                ...
                userChannels.forEach(channel => {
                    ...
                    console.log(
                        `User joined channel: ${channel._id}`
                    );
                });
        ...
        if (
            userData.channels &&
            Array.isArray(userData.channels)
        ) {
            ...
            async (change) => {
                ...
                if (
                    ...
                    if (!messageDetails.sender) {
                        ...
                        console.log(
                            "Skipping socket emit: Message has no sender ID",
                            messageDetails
                        );
